...
export function SignUpForm({
  ...
  const allowedEmailDomains = [
    "@qq.com", "@163.com", "@aliyun.com", "@dingtalk.com", "@email.cn", "@foxmail.com", "@gmail.com", "@gmx.com", "@gmx.de", "@hotmail.com", "@live.cn", "@live.com", "@mail.com", "@mail.retiehe.com", "@mail.ru", "@me.com", "@msn.cn", "@msn.com", "@my.com", "@net-c.com", "@outlook.com", "@outlook.jp", "@petalmail.com", "@retinbox.com", "@sina.cn", "@sina.com", "@sohu.com", "@tom.com", "@tutanota.com", "@vip.qq.com", "@vip.163.com", "@wo.cn", "@yahoo.co.jp", "@yahoo.com", "@yahoo.com.hk", "@yahoo.com.tw", "@yandex.com", "@yandex.ru", "@yeah.net", "@111.com", "@126.com", "@139.com", "@proton.me", "@pm.me", "@protonmail.com", "@protonmail.ch",
  ];

  const isEmailDomainAllowed = (email: string) =>
    allowedEmailDomains.some((domain) => email.toLowerCase().endsWith(domain));
  ...
  const handleOAuthSignUp = (strategy: "oauth_google" | "oauth_microsoft" | "oauth_github") => {
    ...
    const redirect =
      ...
      (signUp as unknown as { authWithRedirect?: typeof signUp.authenticateWithRedirect }).authWithRedirect;
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">Start using One Calendar in minutes</p>
              </div>
              ...
              {siteKey && (
                <Field>
                  <Turnstile
                    ...
                    options={{ theme: "auto", action: "sign-up", cData: "sign-up-page", refreshExpired: "auto", size: "flexible" }}
                  />
                </Field>
              )}
              ...
              <Field>
                <Button type="submit" className="w-full" disabled={isLoading || (siteKey && !isCaptchaCompleted)}>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" onClick={() => handleOAuthSignUp("oauth_microsoft")}>
                ...
                <Button variant="outline" type="button" onClick={() => handleOAuthSignUp("oauth_google")}>
                ...
                <Button variant="outline" type="button" onClick={() => handleOAuthSignUp("oauth_github")}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                    <path
              ...
              <FieldDescription className="text-center">
                Already have an account? <a href="/sign-in" className="underline underline-offset-2">Sign in</a>
              </FieldDescription>
            </FieldGroup>
          </form>
