...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "In just a few minutes, we managed our schedule. The process was seamless and incredibly efficient!",
      name: "Jamie Marshall",
      company: "",
      image:
    ...
    {
      quote:
        "One Calendar protects my schedule and share with E2EE. And the AI saves us hours every week.",
      name: "Sarah Chen",
      company: "",
      image:
    ...
    {
      quote:
        "With One Calendar, I can do more things after managed the time.",
