      ...
      <div className="w-14 bg-background border-l flex flex-col items-center py-4 absolute right-0 top-16 bottom-0 z-30">
        <div className="flex flex-col items-center space-y-4 flex-1">
          ...
          >
            <div
              className={cn(
                "w-10 h-10 rounded-full flex items-center justify-center bg-cyan-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]",
          ...
          >
            <div
              className={cn(
                "w-10 h-10 rounded-full flex items-center justify-center bg-sky-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]",
          ...
          <WeatherSheet
            trigger={
              ...
              >
                <div
                  className={cn(
                    "w-10 h-10 rounded-full flex items-center justify-center bg-blue-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]",
                  )}
                >
          ...
          >
            <div className="w-10 h-10 rounded-full flex items-center justify-center bg-indigo-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]">
          ...
          >
            <div className="w-10 h-10 rounded-full flex items-center justify-center bg-violet-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]">
        ...
        trigger={
          ...
          >
            <div
              className={cn(
                "w-10 h-10 rounded-full flex items-center justify-center bg-teal-500 green:bg-[#24a854] orange:bg-[#e26912] azalea:bg-[#CD2F7B] pink:bg-[#FFAFA5]",
...
## 角色定位
你是一个专业且友好的日历应用 AI 助手，专门负责日历、日程和时间管理相关服务。你的交流风格自然亲切，如朋友般温暖，同时保持专业水准。
