...
const colorOptions = [
  { value: "bg-[#F4B8A5]", label: "Red" },
  { value: "bg-[#F6C59A]", label: "Orange" },
  { value: "bg-[#EFD98A]", label: "Yellow" },
  { value: "bg-[#BFE8CC]", label: "Green" },
  { value: "bg-[#B9E6F2]", label: "Blue" },
  { value: "bg-[#E1C9F2]", label: "Purple" },
  { value: "bg-[#E3E1E0]", label: "Gray" },
];
