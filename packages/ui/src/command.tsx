...
import { InputGroup, InputGroupAddon } from '@zntr/ui/input-group'
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        // data-[selected=true], not the repo's `data-selected` custom
        // variant: that variant matches [data-state=selected] (Radix),
        // while cmdk marks the active item with data-selected="true".
