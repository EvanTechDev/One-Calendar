...
export const DubIcon = ({ className }: IconProps) => (
  ...
  >
    <path
      fill="#3B82F6"
      d="M4 4h6c5.523 0 10 4.477 10 10S15.523 24 10 24H4V4zm4 4v12h2c3.314 0 6-2.686 6-6s-2.686-6-6-6H8z"
    />
  </svg>
)
...
export const GmailIcon = ({ className }: IconProps) => (
  ...
  >
    <path
      fill="#4285F4"
      d="M2 6.5A1.5 1.5 0 0 1 3.5 5h17A1.5 1.5 0 0 1 22 6.5V8l-10 6.5L2 8V6.5Z"
    />
    <path fill="#34A853" d="M22 8v9.5a1.5 1.5 0 0 1-1.5 1.5H14v-7l8-4Z" />
    <path fill="#FBBC05" d="M2 8v9.5A1.5 1.5 0 0 0 3.5 19H10v-7L2 8Z" />
    <path
      fill="#EA4335"
      d="M2 6.5 12 13l10-6.5A1.5 1.5 0 0 0 20.5 5h-17A1.5 1.5 0 0 0 2 6.5Z"
    />
  </svg>
)
...
export const PolarIcon = ({ className }: IconProps) => (
  ...
  >
    ...
    <path
      ...
      strokeWidth="1.5"
      strokeLinecap="round"
      d="M12 2.5V7M12 17v4.5M2.5 12H7M17 12h4.5"
    />
  </svg>
)
