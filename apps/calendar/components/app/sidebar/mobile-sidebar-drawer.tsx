...
export default function MobileSidebarDrawer({
  ...
  return (
    ...
    >
      {/* w-[247px]!: the same fixed width as the desktop sidebar column, so
          the drawer IS the sidebar, not a re-layout of it. The `!` is load-
          bearing — the sheet's own data-[side=left]:w-3/4 compiles to a
          two-class selector that out-specifies a plain width utility. */}
