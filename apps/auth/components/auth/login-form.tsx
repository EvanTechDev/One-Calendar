...
interface LoginFormProps {
   ...
   * registered clients by the page — never take this straight from the query
   * string (see @zntr/auth/return-to).
   */
  returnTo?: string
}
...
export function LoginForm({ returnTo = '/' }: LoginFormProps) {
  ...
  /**
   * `returnTo` usually points at a client app, which the Next router cannot
   * navigate to — it only handles in-app routes. Absolute URLs go through a
   * full page load instead. Already allowlisted server-side.
   */
