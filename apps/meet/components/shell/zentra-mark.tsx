/**
 * The Zentra mark, so the meet Shell's brand block matches the calendar's
 ...
 * applies to code, but the same structure decides this).
 */
export function ZentraMark({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="324.5 178.12 367.99 643.88"
      aria-label="Zentra Meet"
      role="img"
      className={className}
    >
      <g
