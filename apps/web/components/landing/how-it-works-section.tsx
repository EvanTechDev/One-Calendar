...
const steps = [
  {
    ...
    description:
      'Add events with title, description, time range, and reminders without leaving context.',
    code: `const event = {
  title: 'Design review',
  start: '09:30',
  end: '10:30'
...
calendar.create(event)`,
  },
  {
    ...
    description:
      'Move and resize events directly on the calendar with keyboard-friendly shortcuts.',
  ...
  },
  {
    ...
    description:
      'Use optional cloud sync and share links to coordinate with your team when needed.',
    code: `calendar.share({
  visibility: 'team',
  expires: '7d'
})
